...
- 🧗 I'm currently getting into rock climbing. I'm working on V2 and V3 routes as of the time of writing.
...
-   <a href="https://github.com/a-urq/ecape4j">Ecape4J</a>: A simple library that computes ECAPE according to <a href="https://arxiv.org/pdf/2301.04712.pdf">Peters et. al. 2023</a>. This library will also soon be able to compute the entrained parcel path, which will open the door to entrained convective parameters (LCL, EL, etc). Licensed under the MIT License.
