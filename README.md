...
- <a href="https://github.com/kylejgillett/sounderpy">SounderPy</a>: Contributed to the integration of <a href="https://github.com/a-urq/ecape-parcel-py">ecape_parcel_py</a>'s parcel computation logic.
...
## Java
-   ⭐ <a href = "https://github.com/a-urq/radarview-legacy">RadarView</a>: A free and open-source radar viewing program meant to have many advanced features such as precipitation types and vertical atmospheric profiles. Graphical frontend is currently undergoing a rewrite from the ground up. Licensed under GPL-3.0.
...
-   ⭐ <a href = "https://github.com/a-urq/timelapse-utils">Timelapse Utils</a>: A collection of standalone programs that each serve a specific function in my timelapse photography workflow. LRTimelapse is expensive and ffmpeg likes to complain. Licened under the GPL-3.0.
-   ⭐ <a href="https://github.com/a-urq/wx-archives">WxArchives</a>: An interface for the AWS NEXRAD Level-II archive as well as other meteorological archive data sources, such as the Iowa State Watch, Warning, and Advisory Archive. Used to add warning polygons to the Radar & Sat plots on the Chase Archive. Licensed under the MIT License.
