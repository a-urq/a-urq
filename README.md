...
-   ⭐ <a href = "https://github.com/a-urq/timelapse-utils">Timelapse Utils</a>: A collection of standalone programs that each serve a specific function in my timelapse photography workflow. LRTimelapse is expensive and ffmpeg can be finicky. Licensed under the GPL-3.0.
